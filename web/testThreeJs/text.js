...
function textDrawer(canvas2d, canvas, gl) {
...
//           gl = canvas.getContext("webgl");
      ...
      void main() {
        vec2 pos = position;
        pos.y += pow(sin( pos.y / 100.+ uTime *4.),2.) * 80.;
        // pos.x += sin(pos.x/20. + uTime) * 20.;
      ...
      void main() {
        gl_FragColor = uColor;
          ...
          gl.linkProgram(prog);
          const [uScale, uOffset, uColor, uTime] = ["uScale", "uOffset", "uColor", 'uTime']
